...
export class AppComponent implements OnInit, OnDestroy {
  ...
  ngOnInit(): void {
    ...
    this.renderer.setAttribute(document.documentElement, 'lang', 'fa');
        ...
        if (
          ...
          if (
            ...
            this.toastService.show({
              content: $localize`Document ${status.filename} was added to Storex.`,
              delay: 10000,
    ...
    this.newDocumentSubscription = this.websocketStatusService
      ...
      .subscribe((status) => {
        ...
        if (
          ...
          this.toastService.show({
            content: $localize`Document ${status.filename} is being processed by StoreX.`,
            delay: 5000,
          })
        }
      })
    ...
    this.tourService.initialize(
      [
        ...
        },
        {
          ...
          content: $localize`Drag-and-drop documents here to start uploading or place them in the consume folder. You can also drag-and-drop documents anywhere on all other pages of the web app. Once you do, StoreX will start training its machine learning algorithms.`,
          route: '/dashboard',
        },
        {
        ...
        },
        {
          ...
          content:
            ...
            '<br/><br/>' +
            $localize`Lastly, on behalf of every contributor to this community-supported project, thank you for using StoreX!`,
          route: '/dashboard',
          isOptional: false,
          backdropConfig: {
            offset: 0,
